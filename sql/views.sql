...
SELECT
    ...
    CAST(s.total_cost_usd AS FLOAT64) AS total_cost_usd,
    s.days_to_coverage,
    CAST(s.sla_penalty_usd AS FLOAT64) AS sla_penalty_usd,
    CAST(s.total_exposure_usd AS FLOAT64) AS total_exposure_usd,
    s.feasible,
    s.solver_status,
    s.result_sha256,
    s.created_at
